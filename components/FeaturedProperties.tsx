...
export default function FeaturedProperties() {
  ...
  return (
    <section className="w-full bg-white py-16 sm:py-20 overflow-x-clip">
      <div className="flex flex-col gap-12">
        ...
        {/* Scroll Track — aligned with other sections, fades on both edges */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative">
            {/* Left fade */}
            <div className="absolute inset-y-0 left-0 w-6 sm:w-10 bg-gradient-to-r from-white to-transparent z-10 pointer-events-none" />
            {/* Right fade */}
            <div className="absolute inset-y-0 right-0 w-20 sm:w-28 bg-gradient-to-l from-white to-transparent z-10 pointer-events-none" />
        <div
          ref={scrollRef}
        ...
        >
          {properties.map((property) => (
            <div
              key={property.id}
              className="min-w-[300px] sm:min-w-[340px] lg:min-w-[360px] flex-shrink-0 bg-stone-50 border border-stone-100 rounded-2xl p-5 flex flex-col gap-4"
            >
              {/* Image */}
