    ...
    <>
      ...
      <main className="min-h-screen bg-[#E7E5E4] flex flex-col pb-16">
        ...
        <section className="w-full max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          <div className="relative w-full rounded-3xl overflow-hidden min-h-[280px] sm:min-h-[360px] flex items-center justify-center shadow-xl border border-stone-200/50">
